...
public class JUnit5F100x2 {
    ...
    static Iterable<Object[]> genRandomQuantitySingle() {
        return TestProvider.create(ConfigDefault.MODEL).generateRandom(ConfigDefault.F_100x2, ParamsRandom.create()
                .feedback()
                .length(1)
    ...
    static Iterable<Object[]> genNWise() {
        return TestProvider.create(ConfigDefault.MODEL).generateNWise(ConfigDefault.F_100x2, ParamsNWise.create()
                .feedback()
                .label("NWise"));
    }
